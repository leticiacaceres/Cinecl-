...
export default function Home() {
  ...
  const filmes = [
    ...
    { titulo: "Homem Aranha", imagem: "https://br.web.img3.acsta.net/pictures/22/11/02/16/59/5983491.jpg", descricao: "Peter Parker enfrenta vilões do multiverso em uma aventura épica." },
    ...
    { titulo: "Deadpool", imagem: "https://br.web.img3.acsta.net/pictures/24/05/22/20/20/2953843.jpg", descricao: "O mercenário mais folgado do mundo salva o dia do seu jeito." },
    { titulo: "Coraline", imagem: "https://br.web.img3.acsta.net/pictures/210/316/21031629_20130712172033858.jpg", descricao: "Coraline descobre uma porta secreta para um mundo paralelo sombrio." },
    { titulo: "Harry Potter", imagem: "https://br.web.img3.acsta.net/pictures/14/09/15/19/28/584739.jpg", descricao: "O menino que sobreviveu descobre que é um bruxo e vai para Hogwarts." },
    { titulo: "Divertida Mente", imagem: "https://br.web.img3.acsta.net/pictures/15/05/14/18/00/103512.jpg", descricao: "As emoções de uma menina trabalham juntas dentro da cabeça dela." },
